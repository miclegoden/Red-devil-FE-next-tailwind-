                    ...
                    <div className="flex flex-col">
                      <div className="flex items-center flex-col space-y-4">
                        ...
                        <div className="flex flex-col items-center ml-3">
                          <h2 className="text-blue-900 text-2xl font-[Rancho] tracking-widest">
                            {member.name}
                          </h2>
          ...
          <div className="lg:flex flex-row items-center w-[100%]  justify-between overflow-x-hidden pb-12 ">
            ...
            <div className="flex lg:w-[41%] h-[100%] items-center justify-center md: w-[50%]">
              <Link
                ...
                className="text-[18px] border-none text-center text-main w-[34.6%] h-[71.89px] rounded-[12px] bg-red-700 transition-all duration-500 font-bold py-5 font-[Rancho] tracking-widest"
              >
                Our Discord
              </Link>
